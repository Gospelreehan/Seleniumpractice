...
public class ExtentReportListener extends Repetitive_values implements ITestListener{
...
//	
 ...
 // in to the report using ExtentTest class
		...
		test.log(com.aventstack.extentreports.Status.PASS, result.getName()+"_"+"got successfully executed");
	}  
	...
	public void onTestFailure(ITestResult result) {  
		...
		test.log(com.aventstack.extentreports.Status.FAIL, result.getName()+"_"+"got failed.The error is_"+result.getThrowable());
	...
	public void onTestSkipped(ITestResult result) {  
		test=extent.createTest(result.getTestClass().getName());
		test.assignCategory(result.getMethod().getGroups());
		test.log(com.aventstack.extentreports.Status.SKIP, result.getName()+"_"+"got skipped");
		test.log(com.aventstack.extentreports.Status.INFO, result.getThrowable().getMessage()); 
	}  
